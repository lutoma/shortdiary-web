...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'diary_payment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['diary.DiaryUser'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('gateway', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('gateway_identifier', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ...
            ('recurring', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'diary', ['Payment'])


    def backwards(self, orm):
        # Deleting model 'Payment'
        db.delete_table(u'diary_payment')
