...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.natural_language'
        db.add_column(u'diary_post', 'natural_language',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.natural_language'
        db.delete_column(u'diary_post', 'natural_language')
    ...
    models = {
        ...
        u'diary.post': {
            ...
            'natural_language': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
