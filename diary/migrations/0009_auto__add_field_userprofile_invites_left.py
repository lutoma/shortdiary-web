...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.invites_left'
        db.add_column('diary_userprofile', 'invites_left',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.invites_left'
        db.delete_column('diary_userprofile', 'invites_left')
