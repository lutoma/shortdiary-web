...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.location_lat'
        db.add_column('diary_post', 'location_lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'Post.location_lon'
        db.add_column('diary_post', 'location_lon',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'Post.location_verbose'
        db.add_column('diary_post', 'location_verbose',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.location_lat'
        db.delete_column('diary_post', 'location_lat')

        # Deleting field 'Post.location_lon'
        db.delete_column('diary_post', 'location_lon')

        # Deleting field 'Post.location_verbose'
        db.delete_column('diary_post', 'location_verbose')
