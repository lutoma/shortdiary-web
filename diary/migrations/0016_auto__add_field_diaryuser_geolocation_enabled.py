...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiaryUser.geolocation_enabled'
        db.add_column(u'diary_diaryuser', 'geolocation_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiaryUser.geolocation_enabled'
        db.delete_column(u'diary_diaryuser', 'geolocation_enabled')
