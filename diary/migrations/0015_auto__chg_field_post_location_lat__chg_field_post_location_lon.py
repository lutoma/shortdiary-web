...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.location_lat'
        db.alter_column(u'diary_post', 'location_lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=12))

        # Changing field 'Post.location_lon'
        db.alter_column(u'diary_post', 'location_lon', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=12))

    def backwards(self, orm):

        # Changing field 'Post.location_lat'
        db.alter_column(u'diary_post', 'location_lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6))

        # Changing field 'Post.location_lon'
        db.alter_column(u'diary_post', 'location_lon', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6))
