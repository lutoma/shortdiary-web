...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'diary_userprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['diary.DiaryUser'], unique=True)),
            ...
            ('invited_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_invited_by', null=True, to=orm['diary.DiaryUser'], blank=True)),
        ))
